...
{
    private $queryPost = 'INSERT INTO region(idReg,nombreReg,idDep) VALUES(:num,:nameregion,:iddep)';
    private $queryGetAll = 'SELECT * FROM region';
    private $queryUpdate = 'UPDATE region SET idReg = :num, nombreReg = :nameregion, idDep = :iddep  WHERE idReg = :num';
    private $queryDelete = 'DELETE FROM region WHERE idReg = :num';
    private $message;
    use getInstance;  
    ...
    public function postRegions()
    {
        try {
            ...
            $res->bindValue("num", $this->idReg);
            $res->bindValue("nameregion", $this->nombreReg);
