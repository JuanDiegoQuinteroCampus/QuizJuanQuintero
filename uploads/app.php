...
/* personal_ref::getInstance(json_decode(file_get_contents("php://input"), true))->deleteJourney(); */
/* working_info::getInstance(json_decode(file_get_contents("php://input"), true))->postWork_info(); */
/* position::getInstance(json_decode(file_get_contents("php://input"), true))->putAreas(); */
/* working_info::getInstance(json_decode(file_get_contents("php://input"), true))->getAllWork_info(); */